...
def deploy(web3: Web3, deployer_address: str, deployer_privateKey: str, player_address: str) -> str:
    ...
    fake_flag = "RSCTF_DYNAMIC_FLAG_47ac33ec2e33c84c38afdeab2"
    fake_flag_2 = "RSCTF_DYNAMIC_FLAG_47ac33ec2e33c84c38afdeab2"
    real_flag = "RSCTF_DYNAMIC_FLAG_47ac33ec2e33c84c38afdeab2"
